...
import (
	...
	"github.com/kubeedge/kubeedge/edge/pkg/groupmanager"
...
func registerModules(c *v1alpha2.EdgeCoreConfig) {
	...
	metamanager.Register(c.Modules.MetaManager, c.Modules.Edged.NodeIP)
	...
	//add by juju
	groupmanager.Register(c.Modules.GroupManager, c.Modules.Edged.HostnameOverride, c.Modules.Edged.NodeIP)
