...
type Modules struct {
	...
	// GroupManager indicates GroupManager module config
	// +Required
	GroupManager *GroupManager `json:"groupManager,omitempty"`
}
...
// GroupManager indicates the GroupManager module config
